    ...
    opts = {
      ...
      prompts = {
        CommitAll = {
          ...
          prompt = "Write commit message for the change with commitizen convention no need explanation this commit message generated by copilot chat in the convetion. Keep the title under 50 characters and wrap message at 72 characters. Format as a gitcommit code block.",
          sticky = "#git:unstaged #git:staged",
        },
        ExplainChanged = {
          system_prompt = [[
